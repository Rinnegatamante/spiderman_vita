	...
	*(uintptr_t *)(fake_env + 0x234) = (uintptr_t)CallStaticVoidMethod;
	...
	while (1) {
		...
		if (is_xperia) { // Xperia build
			...
			physicalInput(SCE_CTRL_UP, KEYCODE_DPAD_UP, SCANCODE_UNK)
			physicalInput(SCE_CTRL_LEFT, KEYCODE_DPAD_LEFT, SCANCODE_UNK)
			physicalInput(SCE_CTRL_RIGHT, KEYCODE_DPAD_RIGHT, SCANCODE_UNK)
			physicalInput(SCE_CTRL_DOWN, KEYCODE_DPAD_DOWN, SCANCODE_UNK)
			...
			physicalInput(SCE_CTRL_START, KEYCODE_BUTTON_SELECT, SCANCODE_UNK)
			physicalInput(SCE_CTRL_SELECT, KEYCODE_BUTTON_START, SCANCODE_UNK)
		} else { // Generic build
